...
class PersonTests: XCTestCase {
    func testDescription() {
        ...
        XCTAssert(ted.description == "Ted Neward is a 45-year-old person with no job and with no spouse")
    }
...
class FamilyTests : XCTestCase {
    func testDescription() {
        ...
        XCTAssert(family.description == "This family has members : Ted Neward, Charlotte Neward, and the household income is 1000")
    }
